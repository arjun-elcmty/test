		...
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div className="flex flex-col justify-center items-center">
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Keifan" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Farrel" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Masha" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Arjun" Width="120px" />
					</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Iqbal" Width="120px" />
					</div>
				</div>
				...
				<div className=" absolute bottom-[15%] " data-aos="fade-up" data-aos-duration="1000">
					<div className="flex justify-center items-center flex-col">
						...
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Keamanan" Nama="Candra" Width="120px" />
							<BorderStruktur Jabatan="" Nama="Fandika" Width="120px" />
						</div>
					</div>
				</div>
